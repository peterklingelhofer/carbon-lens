...
export interface components {
    schemas: {
        ...
        CarbonForecast: {
            ...
            /**
             * Method
             * @description How the curve was produced: 'entsoe_day_ahead' (real EU day-ahead wind/solar/load forecast) or 'time_of_day_model' (a local time-of-day heuristic, with no forecast data behind it).
             */
            method: string;
            /**
             * Points
        ...
        CarbonIntensity: {
             ...
             * @description Estimated marginal emission factor (what an extra kWh of demand would emit). A heuristic from the fuel mix; the margin isn't measured. None for sources without a real fuel mix.
             */
...
export interface operations {
    ...
    honesty_api_v1_healthz_honesty_get: {
        parameters: {
            query?: {
                /** @description Return 503 unless the marginal signal is measured */
