    ...
    <div style={section}>
      ...
      <div style={{ ...card, marginTop: "1.5rem" }}>
        ...
        <p style={{ color: "var(--gray-600)", fontSize: "0.95rem" }}>
          ...
          sprawling data pipeline, so it draws little power to run, and it sleeps after a
        ...
        >
          This is the grid's latest carbon intensity (location-based): measured at the grid, with no certificate matching. It's
          stand-in from the same Oregon / US-NW-BPAT zone our server sits in, so it moves hour to
