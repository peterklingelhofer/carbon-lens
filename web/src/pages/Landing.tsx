      ...
      <section style={section}>
        ...
        <div style={{ ...card, marginTop: "1.5rem" }}>
          ...
          <p style={{ color: "var(--gray-600)", fontSize: "0.95rem" }}>
            ...
            report. It's real money funding real renewables, and the claim is an accounting match. It doesn't show
        ...
        <div style={{ ...card, overflow: "auto" }}>
          ...
          >
            ...
            Britain). Carbon is measured at that grid, the one the datacenter draws from.
          </p>
        </div>
