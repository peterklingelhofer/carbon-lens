  ...
  return (
    <div>
      ...
      >
        ...
        >
          In this day and age, if you're hosting a website, you may as well host it on 100%
          renewable energy. Carbon Lens provides observability into which cloud regions emit the
          least carbon by aggregating grid data from dozens of sources, making what was an opaque
      ...
      <section style={section}>
        ...
        <div style={card}>
          ...
          <p style={{ color: "var(--gray-600)", fontSize: "0.95rem" }}>
            ...
            report. That money does fund new renewables, but it's an accounting match, not proof
