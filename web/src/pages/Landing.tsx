      ...
      <section style={section}>
        ...
        <div style={{ ...card, marginTop: "1.5rem" }}>
          ...
          <p style={{ color: "var(--gray-600)", fontSize: "0.95rem" }}>
            ...
            an accounting match. It doesn't show that clean electrons ran your job.
          </p>
          ...
          <p style={{ color: "var(--gray-600)", fontSize: "0.95rem", margin: 0 }}>
            ...
            emissions measured from live grid data.
          </p>
        </div>
        ...
        <div style={grid3}>
          {[
            ...
            },
            {
              ...
              tip: "'Routing' means choosing where to run a job. You set priorities (e.g. favour low carbon, cap cost), it ranks every region and returns the best match. It recommends, but it doesn't move anything itself.",
            },
            {
            ...
            },
            {
              ...
              tip: "Modelled on an SLA (service-level agreement), a measurable promise about a service, here a carbon ceiling (e.g. 'stay under 100 gCO₂/kWh'). Beta: checks run in memory and reset on restart, and carry no third-party assurance.",
            },
          ].map((item) => (
          ...
          >
            {[
              ...
              },
              {
                step: "2",
                title: "Compare",
                desc: "Set your priorities (e.g. greenest within a cost limit) and get the best region to run in. It returns a recommendation, but acting on the result is your call.",
              },
              {
                step: "3",
                title: "Report",
        ...
        <div style={{ ...card, overflow: "auto" }}>
              ...
              <tr style={{ borderBottom: "2px solid var(--gray-200)" }}>
                ...
                <th style={{ textAlign: "left", padding: "0.5rem" }}>
                  <span style={{ display: "inline-flex", alignItems: "center" }}>
                    ...
                    <InfoTip
                      label="data type"
                      text="Live API = read directly from the grid operator's official real-time feed. Heuristic = an estimate from typical regional values and time of day. Weather estimate = carbon inferred indirectly from local solar/wind weather."
                    />
                  </span>
                </th>
                <th style={{ textAlign: "left", padding: "0.5rem" }}>
          ...
          <p style={{ fontSize: "0.8rem", color: "var(--gray-400)", marginTop: "0.75rem", marginBottom: 0 }}>
            ...
            (California), National Grid ESO (Great Britain). Carbon is measured at that grid, the one the datacenter draws from.
          </p>
        </div>
