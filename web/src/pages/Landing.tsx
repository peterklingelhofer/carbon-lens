        ...
        <div style={grid3}>
          {[
            ...
            },
            {
              ...
              desc: "Define carbon targets, run on-demand and background compliance checks against live grid data, and generate attestation-style summary reports. (In-memory, without third-party assurance.)",
            },
          ].map((item) => (
