    ...
    <div>
      ...
      >
        ...
        >
          ...
          Powered by 11 government-verified grid data sources.
        </p>
        <p
          className="hero-subtitle"
          style={{
      ...
      <section style={section}>
        ...
        <div style={card}>
          <h3 style={{ marginTop: 0 }}>Annual Matching Is Carbon Accounting</h3>
          <p>
        ...
        <div style={grid3}>
          {[
            ...
            },
            {
              ...
              desc: "11 official grid operator sources (EIA, ENTSO-E, AEMO, POSOCO). Actual measured emissions factors.",
            },
            {
            ...
            },
            {
              ...
              desc: "Track actual grid conditions hour by hour. Identify when and where your workloads generate the most emissions.",
            },
            {
              title: "Actionable Optimization",
              desc: "Beyond reporting: route workloads to the cleanest region in real-time. Cut emissions as well as measuring them.",
            },
          ].map((item) => (
