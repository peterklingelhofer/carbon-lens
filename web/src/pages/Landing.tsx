    ...
    <div>
      ...
      <section style={section}>
        ...
        <p style={{ color: "var(--gray-500)", marginBottom: "1.5rem", maxWidth: 680 }}>
          "Runs on 100% renewable energy" almost always describes a year of paperwork. The machine
          itself draws from the local grid, and that grid is what emits.
        </p>
        ...
        <div style={card}>
          ...
          <p style={{ ...body, marginTop: 0, marginBottom: 0 }}>
            ...
            kilowatt-hour than one in Norway or Québec. Picking a clean grid is the larger lever,
            and it's available on every provider. Carbon Lens covers hosts like Hetzner, OVH and
            Scaleway alongside AWS, Azure and Google Cloud for exactly that comparison.
          </p>
        </div>
          ...
          <dl style={{ display: "grid", gap: "1.25rem", margin: 0 }}>
            {[
              ...
              },
              {
                ...
                tip: "Modelled on an SLA (service-level agreement), a measurable promise about a service. Here that promise is a carbon ceiling, e.g. 'stay under 100 gCO₂/kWh'. Beta: checks run in memory and reset on restart, and carry no third-party assurance.",
              },
            ].map((item) => (
              <div key={item.title}>
