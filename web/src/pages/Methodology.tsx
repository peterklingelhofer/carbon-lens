    ...
    <div style={section}>
      ...
      <div style={card}>
        ...
        <p style={p}>
          ...
          electricity on a given grid right now (gCO₂/kWh): a <em>rate</em> per unit of energy. It's a
          <strong> location-based</strong> figure: the average intensity of the physical grid a region
          draws from, regardless of any renewable certificates bought against it. Lower is cleaner.
        </p>
      </div>
      ...
      <div style={{ ...card, marginTop: "1.5rem" }}>
        ...
        <p style={p}>
          ...
          nuclear/hydro grid (France, Sweden, Ontario) can show a modest renewable % while emitting little
          ...
          it by default. Treat renewable % as context.
        </p>
      </div>
      ...
      <div style={{ ...card, marginTop: "1.5rem" }}>
        ...
        <ul style={{ paddingLeft: "1.2rem", margin: 0 }}>
          <li style={li}>
            ...
            clean. Configure a live feed (e.g. an ENTSO-E token) for accurate fuel-mix data.
          </li>
          <li style={li}>
            Integer-looking values don't imply integer accuracy, especially for estimated zones.
          </li>
          <li style={li}>
            The carbon-aware scheduler's future windows use a simplified time-of-day model. It isn't a real forecast.
          </li>
        </ul>
      </div>
      ...
      <div style={{ ...card, marginTop: "1.5rem" }}>
        ...
        <p style={p}>
          ...
          Protocol (Scope 2 + Scope 3 Cat 1). It's a <strong>first draft to build on. It isn't an assured or audited
      ...
      <div style={{ ...card, marginTop: "1.5rem" }}>
        ...
        <p style={{ ...p, margin: 0 }}>
          A free public tool for orientation and first drafts. It isn't assured/audited reporting, and not financial,
