...
export function Methodology() {
  return (
    <div style={section}>
      ...
      >
        How every number on this site is produced, and where it's an estimate rather than a
        measurement. The short version: we read public grid-operator data, tag every reading with
        its source, and never present an estimate as if it were a measured value.
      </p>
      ...
      <div style={{ ...card, marginTop: "1.5rem" }}>
        ...
        <ul style={{ paddingLeft: "1.2rem", margin: "0 0 0.5rem" }}>
          <li style={li}>
            ...
            ENTSO-E (Europe), EIA (United States), UK Carbon Intensity, OpenElectricity (Australia),
            IESO (Ontario) and AESO (Alberta). Each reports a fuel mix; we apply per-fuel emission
            factors to get the intensity.
          </li>
          <li style={li}>
            <strong>Estimated (modelled):</strong> where no live feed covers a zone, a weather-based
            estimate (Open-Meteo) or a regional time-of-day heuristic (India, Brazil, South Africa,
            Québec). Clearly labelled <em>est.</em> everywhere it appears.
          </li>
          <li style={li}>
            <strong>Sample (fallback):</strong> static representative values, last resort so the API
            always returns something. Dropped from the published snapshot, so nothing you see on
      ...
      <div style={{ ...card, marginTop: "1.5rem" }}>
        ...
        <p style={{ ...p, margin: 0 }}>
          The best-time page projects each region's intensity across the delay window. For European
          zones it uses ENTSO-E's <strong>real day-ahead forecast</strong> of wind, solar and load
          to project the renewable share hour by hour; elsewhere, where no free forecast exists, it
          falls back to a simplified time-of-day model anchored to the region's local solar time.
          Treat it as directional guidance.
        </p>
      </div>
      ...
      <div style={{ ...card, marginTop: "1.5rem" }}>
        ...
        <ul style={{ paddingLeft: "1.2rem", margin: 0 }}>
          ...
          <li style={li}>
            Outside Europe the future windows use a simplified time-of-day model rather than a real
            forecast (EU zones use ENTSO-E's real day-ahead forecast). The marginal figure is a
            fuel-mix heuristic; marginal data isn't measured.
          </li>
        </ul>
      </div>
      ...
      <div style={{ ...card, marginTop: "1.5rem" }}>
        ...
        <p style={p}>
          The{" "}
          <Link to="/report" style={{ color: "var(--green-text)" }}>
            compliance
          </Link>{" "}
