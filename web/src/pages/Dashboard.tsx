          ...
          <div>
            ...
            {formatLoad(intensity.grid_load_mw) && (
              <span
                ...
                title="Total load for the whole balancing authority (every consumer on that grid, datacenters included)"
              >
          ...
          <div style={card}>
            <div style={{ fontSize: "0.8rem", color: "var(--gray-500)", display: "flex", alignItems: "center" }}>
              ...
              <InfoTip
                ...
                text="How many routing recommendations this demo server has produced: each click of 'Route a sample workload' counts. Tracked in memory, so it resets whenever the server restarts; it counts this instance's activity alone."
              />
            </div>
          ...
          <div style={card}>
            <div style={{ fontSize: "0.8rem", color: "var(--gray-500)", display: "flex", alignItems: "center" }}>
              ...
              <InfoTip
                ...
                text="For each recommendation, the gap in carbon intensity (gCO₂/kWh) between the dirtiest candidate region and the greener one chosen, summed across recommendations. It's illustrative: a per-kWh intensity gap. The figure isn't absolute tonnes, and real savings also depend on how much energy a workload uses."
              />
            </div>
            <div style={{ fontSize: "2rem", fontWeight: 700, color: "var(--green-text)" }}>
