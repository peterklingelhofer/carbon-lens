    ...
    <div style={section}>
      <h1 style={{ marginBottom: "0.5rem", display: "flex", alignItems: "center" }}>
        ...
        <InfoTip
          ...
          text="Turns your cloud usage into a draft greenhouse-gas emissions report, built from real grid data. Aligned with the GHG Protocol (the standard accounting framework) and the EU's CSRD / ESRS E1 disclosure rules. It's a defensible first draft, with no assurance or audit behind it."
        />
      </h1>
