    ...
    <div style={section}>
      <h1 style={{ marginBottom: "0.5rem", display: "flex", alignItems: "center" }}>
        ...
        <InfoTip
          ...
          text="Turns your cloud usage into a draft greenhouse-gas emissions report, built from real grid data. Aligned with the GHG Protocol (the standard accounting framework) and the EU's CSRD / ESRS E1 disclosure rules. It's a useful first draft, with no assurance or audit behind it."
        />
      </h1>
      ...
      >
        <h2 style={{ margin: 0, fontSize: "1.1rem", display: "flex", alignItems: "center" }}>
          ...
          <InfoTip
            label="usage CSV"
            text="Upload a CSV of your real cloud usage and get the same report, calculated against live grid intensity per region. It's processed in memory for this report; nothing is kept long-term."
          />
        </h2>
        <p style={{ color: "var(--gray-500)", fontSize: "0.85rem", margin: 0 }}>
          Columns:{" "}
  ...
  return (
    <div style={{ ...card, marginBottom: "2rem" }}>
      {isDemo && (
        ...
        >
          Demo data: synthetic usage standing in for a real workload
        </div>
      )}
      <div
        style={{
      ...
      >
        <div style={{ fontWeight: 600, fontSize: "0.9rem", marginBottom: 4, display: "inline-flex", alignItems: "center" }}>
          ...
          <InfoTip
            ...
            text="Simplified screening only: this flags 'aligned' purely from a high renewable share. Real EU Taxonomy alignment also requires technical screening criteria, Do-No-Significant-Harm, and minimum safeguards, none of which are assessed here. Treat as indicative only."
          />
        </div>
