...
function RegionForecast({ provider, region }: { provider: string; region: string }) {
...
export default function CarbonGlobe() {
  ...
  useEffect(() => {
    ...
    // Pause auto-rotation while the user is interacting, and resume after.
    ...
    >
      <style>{`
        ...
        @media (max-width: 720px) {
          ...
          /* Legend: collapse behind a toggle, and hide everything but the toggle when closed */
          .globe-legend-toggle {
