...
const TIP = {
  ...
  renewable:
    "Share of the grid's electricity from renewables (wind, solar, hydro) right now. Note: low-carbon grids that lean on nuclear (e.g. France, Sweden) can show a low renewable % while still emitting little CO₂.",
  gridZone:
    "The electricity grid (balancing authority) powering this region: e.g. US-NW-BPAT for Oregon, SE-SE3 for southern Sweden. Carbon is measured at the grid that powers the datacenter.",
  source:
