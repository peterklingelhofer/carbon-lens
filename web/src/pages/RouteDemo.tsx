...
const TIP = {
  emissions:
    "Carbon emitted per kilowatt-hour of electricity, in gCO₂/kWh: an intensity (emissions per unit of power). Lower is cleaner.",
  renewable:
    "Share of the grid's power from renewables (wind, solar, hydro) right now. Low-carbon grids that lean on nuclear (e.g. France, Sweden) can show a low renewable % while still emitting little CO₂; where no live fuel-mix feed is configured, this falls back to a weather estimate that only sees solar and wind.",
  gridZone:
    "The electricity grid (balancing authority) powering this region, e.g. SE-SE3 for southern Sweden. Carbon is measured at the grid serving the datacenter.",
};
                ...
                <table style={{ width: "100%", borderCollapse: "collapse", fontSize: "0.85rem" }}>
                  <thead>
                    <tr style={{ borderBottom: "2px solid var(--gray-200)" }}>
                      <Th label="#" tip="Rank by your carbon/cost priority. #1 is the recommended region above, and these are the next-best." />
                      ...
                      <Th label="Score" tip="Ranking score derived from carbon intensity (lower = greener). It's a relative ordering within this result set, carrying no physical unit, and isn't comparable across different queries. Cost isn't yet a factor." align="right" />
                    </tr>
                  </thead>
                  <tbody>
