...
const TIP = {
  ...
  renewable:
    "Share of the grid's power from renewables (wind, solar, hydro) right now. Low-carbon grids that lean on nuclear (e.g. France, Sweden) can show a low renewable % while still emitting little CO₂ - and where no live fuel-mix feed is configured, this falls back to a weather estimate that only sees solar and wind.",
  gridZone:
                ...
                >
                  <thead>
                    <tr style={{ borderBottom: "2px solid var(--gray-200)" }}>
                      ...
                      <Th
                        label="Score"
                        tip="Ranking score derived from carbon intensity (lower = greener). It's a relative ordering within this result set with no physical unit, and isn't comparable across different queries. Cost isn't yet a factor."
                        align="right"
                      />
                    </tr>
                  </thead>
