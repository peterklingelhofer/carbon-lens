                ...
                <table style={{ width: "100%", borderCollapse: "collapse", fontSize: "0.85rem" }}>
                  <thead>
                    <tr style={{ borderBottom: "2px solid var(--gray-200)" }}>
                      ...
                      <Th label="Score" tip="Internal ranking score from your carbon-vs-cost weighting. Lower is a better match for your chosen priorities. It's a relative ordering with no physical unit." align="right" />
                    </tr>
                  </thead>
                  <tbody>
