    ...
    <div style={section}>
      ...
      {reportMutation.data && (
        <div style={{ ...card, marginBottom: "2rem" }}>
          ...
          >
            Self-generated summary, not a third-party-assured attestation. Checks are in-memory and
            reset on restart, so a freshly-created SLA may summarise a single check over the stated
            period rather than continuous history.
          </div>
          <div
            style={{
              fontSize: "0.8rem",
