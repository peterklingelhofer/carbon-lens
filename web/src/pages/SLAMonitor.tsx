      ...
      {reportMutation.data && (
        <div style={{ ...card, marginBottom: "2rem" }}>
          ...
          <div style={{ fontSize: "0.78rem", color: "var(--gray-400)", marginBottom: "0.75rem" }}>
            Self-generated summary with no third-party assurance. Checks are in-memory and reset on restart,
          ...
          <div style={{ fontSize: "0.8rem", color: "var(--gray-500)", marginBottom: "1rem" }}>
            {new Date(reportMutation.data.period_start).toLocaleDateString()} to {new Date(reportMutation.data.period_end).toLocaleDateString()}
