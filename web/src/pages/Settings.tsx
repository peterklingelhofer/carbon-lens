  ...
  return (
    <div style={section}>
      ...
      <div style={card}>
        ...
        >
          Providers with credentials deliver real-time grid data. No-key providers work out of the
          box.
        </p>
        {providers ? (
          <div
        ...
        >
          ...
          <tbody>
            {[
              {
                name: "EIA",
                coverage: "US grid (real-time)",
                env: "CARBON_LENS_EIA_API_KEY",
                url: "https://www.eia.gov/opendata/",
              },
              {
                name: "GridStatus",
                coverage: "US ISOs",
                env: "CARBON_LENS_GRID_STATUS_API_KEY",
              ...
              },
              {
                ...
                coverage: "Global (paid)",
                env: "CARBON_LENS_ELECTRICITY_MAPS_API_KEY",
