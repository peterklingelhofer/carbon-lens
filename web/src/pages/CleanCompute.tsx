      ...
      {trend.length >= 2 && (
        <section style={{ marginBottom: "2rem" }}>
          ...
          <p style={{ color: "var(--gray-500)", fontSize: "0.85rem", margin: "0 0 0.5rem" }}>
            Average typical intensity of the greenest regions, by day: whether clean compute is
            getting cleaner.
          </p>
          <MiniSparkline
      ...
      {cal && cal.samples > 0 && (
        <section style={{ marginBottom: "2rem" }}>
          ...
          <p style={{ color: "var(--gray-500)", fontSize: "0.85rem", margin: "0 0 0.5rem" }}>
            ...
            across {cal.samples} verified shifted run{cal.samples === 1 ? "" : "s"}: the counterpart
            to any avoided-CO₂ claim.
          </p>
        ...
        <div style={{ display: "grid", gap: "2rem" }}>
          <section>
            ...
            <p style={{ color: "var(--gray-500)", fontSize: "0.85rem", margin: "0 0 0.75rem" }}>
              Lowest typical (history-mean) carbon intensity: the basis for a 24/7 deployment.
            </p>
