...
export function Scheduler() {
  ...
  return (
    <div style={section}>
      ...
      {recommendation && recommended && (
        <div style={{ ...card, border: "1px solid var(--green-300)", marginBottom: "2rem" }}>
          ...
          <p style={{ margin: "-0.5rem 0 1rem", fontSize: "0.78rem", color: "var(--gray-400)" }}>
            ...
            dirtiest candidate region right now. Directional guidance with limited precision.
          </p>
      ...
      <div style={{ ...card, marginBottom: "2rem", borderLeft: "3px solid var(--green-300)" }}>
        <h2 style={{ margin: "0 0 0.5rem", fontSize: "1.1rem" }}>Recommends, doesn't run your job</h2>
        <p style={{ color: "var(--gray-600)", fontSize: "0.9rem", margin: 0 }}>
          ...
          which is a GitHub Action (and CLI) that reads the same kind of live grid data, then skips, waits
