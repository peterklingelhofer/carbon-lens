  ...
  return (
    <div style={{ marginTop: "2rem" }}>
      ...
      >
        ...
        <InfoTip
          label="siting"
          text="Where to PERMANENTLY host a 24/7 workload, ranked by typical (history-mean) carbon intensity: the right basis for an always-on deployment, unlike the instantaneous value used for per-request routing. With a continuous load it shows each region's annual CO2. Region choice is permanent and has a large effect: a region can be many times cleaner, forever."
        />
      </h2>
      <div
        style={{
