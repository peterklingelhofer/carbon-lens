...
export function ScrollToTop() {
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: pathname is the trigger and the body never reads it; the effect must re-run on each navigation to reset scroll.
  useEffect(() => {
    window.scrollTo(0, 0);
  }, [pathname]);
  return null;
