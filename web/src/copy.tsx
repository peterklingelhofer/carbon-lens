...
// surfaces (globe), so the claim says plainly that it's inferred.
export const SURPLUS_TIP =
  "Renewables dominate generation, carbon is low, and little or no fossil sits on the " +
  ...
  "mix; curtailment and price data aren't measured.";
...
export const DATA_QUALITY_TIP =
  ...
  "grid-mix heuristic: a reasonable approximation with no measurement behind it.";
...
export const EMISSIONS_TIP =
  ...
  "unit of power). Lower is cleaner.";
...
export const TABLE_RENEWABLE_TIP =
  ...
  "lean on nuclear (e.g. France, Sweden) can show a low renewable % while still emitting " +
...
export const GRID_ZONE_TIP =
  ...
  "SE-SE3 for southern Sweden. Carbon is measured at the grid supplying the datacenter.";
...
export const DATA_QUALITY_TIP_RICH = (
  <>
    ...
    modelled from weather or a regional grid-mix heuristic: a reasonable approximation with no
