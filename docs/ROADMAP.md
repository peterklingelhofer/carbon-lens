...
### Pricing Strategy
1. **Control plane (API):** Free tier + $29/mo pro, the land step. Low friction, developers try it.
2. **Compute:** Hetzner-competitive pricing, the expand step. Once people see the carbon dashboard, they want managed compute.
3. **Enterprise:** Carbon SLA + Scope 3 reporting, the monetize step. Big companies will pay premium for auditable green compute for ESG compliance.
