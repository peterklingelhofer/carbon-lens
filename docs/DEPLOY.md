...
| **Frontend** | **Cloudflare Pages** | Free, global CDN, and the most explicit renewable-matching commitment of the static hosts. (Netlify also works and is renewable-matched. You just can't pin a region on either, since edge nodes are everywhere.) |
