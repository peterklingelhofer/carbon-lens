"""Measure how much of the UK/EU intensity difference comes from the accounting basis.
...
def run() -> dict:
    ...
    return {
        ...
        "note": (
            "The gap is pure methodology: same grid, same instant, same mix. A UK zone is "
