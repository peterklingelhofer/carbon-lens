...
lives in the companion project carbon-aware-dispatcher, outside this repo. CarbonLens's
...
backtest shows poor agreement the remedy is to add a confidence signal, because
there is none yet to threshold.
