...
- **Live grid-operator APIs (6):** UK, EIA, AEMO, GridStatus, ENTSO-E, Electricity Maps, each fetching and parsing real upstream responses. GridStatus/Electricity Maps need paid keys; ENTSO-E a free token.
- **Heuristic estimators (4):** Grid India, ONS Brazil, Eskom (time-of-day models) and Open-Meteo (rough intensity from weather, which doesn't measure carbon). Demo coverage, tagged as estimates.
