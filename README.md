...
Every major cloud provider claims "100% renewable energy." In practice they use **annual REC matching**, buying solar credits at noon to offset coal burned at midnight. Your 2 AM batch job in Virginia runs on 70% fossil fuels. The provider just buys offsets later.

**Carbon Mesh gives you the real numbers.** Real-time gCO2/kWh for every cloud region, every minute, from government sources.
