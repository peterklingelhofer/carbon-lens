...
from carbonlens.colors import intensity_tier
...
MARGINAL_INTENSITY = Gauge(
    ...
    "Estimated marginal emission factor (gCO2/kWh), a heuristic from the fuel mix",
    _LABELS,
)
GRID_LOAD_MW = Gauge(
    "carbon_grid_load_mw",
...
MARGINAL_UNMAPPED = Gauge(
    ...
    "misconfiguration (run `carbonlens doctor` to see the fix).",
)
...
async def refresh_impact_metrics() -> None:
    ...
    try:
        ...
        from carbonlens.accounting.impact_repo import recent_impacts
