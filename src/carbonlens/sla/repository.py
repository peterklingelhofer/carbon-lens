...
from carbonlens.db.models import GreenSLADB, SLACheckDB, SLAReportDB
from carbonlens.models.sla import GreenSLA, SLACheck, SLAReport
...
class InMemorySLARepository:
    """Process-local store for the demo/test backend. State is lost on restart."""
