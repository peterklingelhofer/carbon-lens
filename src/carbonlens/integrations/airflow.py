...
from carbonlens.sdk import DEFAULT_API_URL, is_good_time
...
class CarbonCleanTrigger(BaseTrigger):
    ...
    def serialize(self) -> tuple[str, dict[str, Any]]:
        return (
            "carbonlens.integrations.airflow.CarbonCleanTrigger",
            {
                "region": self.region,
...
class CarbonAwareSensor(BaseSensorOperator):
    ...
    Frees the worker while waiting and proceeds when the grid is clean or the deadline
