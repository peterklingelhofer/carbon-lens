...
_REGISTRY: dict[str, SourceProvenance] = {
    ...
    "uk_carbon_intensity": _p(
        ...
        caveat=(
            ...
            "zones is additionally inferred from the intensity, since NESO doesn't report it."
        ),
    ),
    "electricity_maps": _p(
        "electricity_maps",
    ...
    "open_meteo": _p(
        ...
        factors=None,
        caveat=(
            "NOT A CARBON MEASUREMENT. The weather data is real, but the mapping from irradiance "
