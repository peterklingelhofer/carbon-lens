...
class ZKJobDB(Base):
    """Stores ZK proof jobs processed by the broker."""

    __tablename__ = "zk_jobs"
    ...
    proof_system: Mapped[str] = mapped_column(String(20), nullable=False)
    circuit_size: Mapped[int] = mapped_column(Integer, nullable=False)
    bounty_usd: Mapped[float] = mapped_column(Float, nullable=False)
    bounty_token: Mapped[str] = mapped_column(String(20), nullable=False)
    status: Mapped[str] = mapped_column(String(20), nullable=False, index=True)

    # Dispatch
    compute_provider: Mapped[str | None] = mapped_column(String(30), nullable=True)
    compute_region: Mapped[str | None] = mapped_column(String(50), nullable=True)
    gpu_type: Mapped[str | None] = mapped_column(String(20), nullable=True)
    grid_zone: Mapped[str | None] = mapped_column(String(30), nullable=True)

    # Economics
    compute_cost_usd: Mapped[float] = mapped_column(Float, nullable=False, default=0.0)
    bounty_earned_usd: Mapped[float] = mapped_column(Float, nullable=False, default=0.0)
    profit_usd: Mapped[float] = mapped_column(Float, nullable=False, default=0.0)

    # Carbon
    carbon_grams_co2: Mapped[float] = mapped_column(Float, nullable=False, default=0.0)
    renewable_percentage: Mapped[float] = mapped_column(Float, nullable=False, default=0.0)
    carbon_intensity_gco2_kwh: Mapped[float] = mapped_column(Float, nullable=False, default=0.0)
    ...
    # Proof
    proof_hash: Mapped[str | None] = mapped_column(String(130), nullable=True)
