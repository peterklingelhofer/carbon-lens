...
DEMO DATA: these are representative, hand-maintained price points. There is no live
...
class SpotPriceFeed:
    ...
    async def _refresh_all(self) -> None:
        ...
        In a production build each of these would fetch from a real source, but
